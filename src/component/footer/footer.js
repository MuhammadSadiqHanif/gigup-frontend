        ...
        <div className="footerMainDiv">
            <div>
                ...
                <div className="d-flex contentDiv">
                    <div className="d-flex col-lg-3 col-sm-12 mr-5 trackMainDiv ">
                        <div className="ArtistImage hideMobile"></div>
                        <div className="trackNameDiv">
                            <p className="trackTitle">Take us Back</p>
                            <p className="trackSlug">Katanak</p>
                        </div>
                    </div>
                    <div className="d-flex col-lg-8 col-sm-12 trackMainDiv space-between">
                        ...
                        <div className="Icons hideMobile right-gap lightIcon"><span onClick={() => setVolume(true)}><SoundSvg /></span> {Volume ? <input type="range" className="rangeInput" /> : null}</div>
